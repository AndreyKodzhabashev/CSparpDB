namespace SoftJail
{
    ...
    public class StartUp
    {
        ...
        private static void ImportEntities(SoftJailDbContext context, string baseDir, string exportDir)
        {
            ...
            var officersPrisoners = DataProcessor.Deserializer.ImportOfficersPrisoners(context,
        ...
        private static void ExportEntities(SoftJailDbContext context, string exportDir)
        {
            ...
            var xmlOutput =
                DataProcessor.Serializer.ExportPrisonersInbox(context, "Melanie Simonich,Diana Ebbs,Binni Cornhill");
