...
{
    public partial class ShadowPropForBankAccountAdded : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Dateofcreation = table.Column<DateTime>(name: "Date of creation", nullable: false),
                    Dateoflastchange = table.Column<DateTime>(name: "Date of last change", nullable: false)
                },
                constraints: table =>
                {
